  ...
  return (
    <div className="Home">
      <div className="Home_header">
        <Link to="/maintenance">
          Accédez aux dernières informations sur les mesures prises par Airbnb face au COVID-19
        </Link>
      </div>
        ...
        <div className="Home_offre_container">
          ...
          <div className="Home_offre_card">
            ...
            <div className="Home_offre_card_text">
              ...
              <p>
                Des logements entiers confortables, avec de la place pour accueillir les amis ou la
                famille.
              </p>
            </div>
          </div>
